Define a subprogram that will ask the user to pick a low and high number, and then generate a random number between those two values and store it in a variable called “comp_num”.
